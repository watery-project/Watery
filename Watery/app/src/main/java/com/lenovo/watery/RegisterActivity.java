...
import com.lenovo.watery.util.MD5Utils;
...
public class RegisterActivity extends AppCompatActivity {
        ...
        private void init() {
            ...
            Drawable drawable=getResources().getDrawable(R.drawable.password_icon);
            drawable.setBounds(0, 0, 40, 40);
            et_psw.setCompoundDrawables(drawable,null,null,null);
            et_psw_again.setCompoundDrawables(drawable,null,null,null);

            Drawable drawable1=getResources().getDrawable(R.drawable.user_name_icon);
            drawable1.setBounds(0, 0, 43, 43);
            et_user_name.setCompoundDrawables(drawable1,null,null,null);
